...
/**
 * The pluggable "document processing tool" this module is a skeleton for.
 * vanban.chinhphu.vn, unlike vbpl.vn, exposes no server-rendered full text —
 * only downloadable PDF/DOC/RTF attachments (see
 * chinhphu-document.interface.ts) — so producing a document_node tree for a
 * chinhphu-sourced document requires first running those attachments
 ...
 * outside this worktree) and deliberately isn't part of this module:
 ...
 * provider in crawl-chinhphu.module.ts for a real implementation once one
 * exists.
 */
